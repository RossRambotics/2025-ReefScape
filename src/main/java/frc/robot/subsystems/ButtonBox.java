...
public class ButtonBox extends SubsystemBase {
    ...
    public ButtonBox() {
        ...
        // joystick2.axisLessThan(0,
        // -0.5).onTrue(RobotContainer.m_armController.getTransition_GroundAlgae());

        joystick2.button(7).onTrue(RobotContainer.m_armBase.getStopArmCmd());
    }
