...
public class RobotContainer {
    ...
    // final static public VisionForOdometry m_visionForOdometry = new
    // VisionForOdometry();
    // final static public ManualArmControl m_manualArmControl = new
    // ManualArmControl();
    ...
    public RobotContainer() {
        ...
        // NamedCommands.registerCommand("Arm.Back_L4",
        // RobotContainer.m_armController.getAutoTransition_Back_L4());
        // NamedCommands.registerCommand("Arm.HumanPlayer",
        // RobotContainer.m_armController.getTransition_HumanPlayerCoral());
        // NamedCommands.registerCommand("Arm.BackScore_L4",
        // RobotContainer.m_armController.getTransition_BackScore_L4());
        // NamedCommands.registerCommand("Reef.1",
        // RobotContainer.m_buttonBox.getReef1Cmd());
        // NamedCommands.registerCommand("Reef.2",
        // RobotContainer.m_buttonBox.getReef2Cmd());
        // NamedCommands.registerCommand("Reef.3",
        // RobotContainer.m_buttonBox.getReef3Cmd());
        // NamedCommands.registerCommand("Reef.4",
        // RobotContainer.m_buttonBox.getReef4Cmd());
        // NamedCommands.registerCommand("Reef.5",
        // RobotContainer.m_buttonBox.getReef5Cmd());
        // NamedCommands.registerCommand("Reef.6",
        // RobotContainer.m_buttonBox.getReef6Cmd());
        // NamedCommands.registerCommand("Reef.Left",
        // RobotContainer.m_buttonBox.getLeftReefCmd());
        // NamedCommands.registerCommand("Reef.Right",
        // RobotContainer.m_buttonBox.getRightReefCmd());
        // NamedCommands.registerCommand("Intake.OutTake",
        // RobotContainer.m_intake.getOuttakeCommand().withTimeout(0.5));
        // // NamedCommands.registerCommand("Intake.InTake", new
        // // EatCoralPlayerStation(m_intake));
        // NamedCommands.registerCommand("Intake.InTake",
        // RobotContainer.m_intake.getIntakeCommand().withTimeout(0.5));
        // NamedCommands.registerCommand("Intake.Stop",
        // RobotContainer.m_intake.getStopCommand());
        // NamedCommands.registerCommand("Reef.LineUp", new ReefLineUp3(drivetrain,
        // targetDrive,
        // RobotContainer.m_targeting::getScoreTargetPose).withTimeout(1.0));
        // NamedCommands.registerCommand("Arm.Carry",
        // RobotContainer.m_armController.getTransition_Carry());
        // NamedCommands.registerCommand("Reef.PathToTarget", new
        // RunPathToTarget(drivetrain, targetDrive));
    ...
    private void configureBindings() {
        ...
        // joystick.leftTrigger().whileTrue(new RunPathToTarget(drivetrain,
        // targetDrive));
